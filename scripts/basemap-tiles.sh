...
# Usage: ./scripts/basemap-tiles.sh <input-file> <output-folder>
# with Docker: docker run -v `pwd`:/data -w /data --name gdal2 -it --rm geographica/gdal2 ./scripts/basemap-tiles.sh <input-file> <output-folder>
