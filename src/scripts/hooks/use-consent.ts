...
export function useConsent() {
  ...
  const enableAnalytics = useCallback(() => {
    ...
    // Media Analytics plugin is not included in the main matomo.js bundle,
    // so we need to load it separately
    script.src = `${config.matomoUrl}/plugins/MediaAnalytics/tracker.min.js`;
    script.async = true;
