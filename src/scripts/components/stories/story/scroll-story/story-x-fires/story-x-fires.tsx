...
import PortugalFiresModule from "./modules/portugal-fires/portugal-fires";
...
export type StoryXFiresCompoundComponents = {
  ...
  PortugalFires: typeof PortugalFiresModule;
...
StoryXFires.PortugalFires = PortugalFiresModule;
