  ...
  return (
    <div className={styles.result}>
      ...
      <div className={styles.resultItem}>
        ...
        <EmbedLinkPreview embedUrl={createEmbedUrl(elementsChecked)} />
